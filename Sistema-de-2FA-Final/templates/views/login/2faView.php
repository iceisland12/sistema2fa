...
<div class="container">
  <div class="py-5 text-center">
    ...
    <h2>Autenticación de 2 factores</h2>
          ...
          <form id="verificacion_form" class="text-center" method="post">
            ...
            <div class="mb-3 row">
              <div class="offset-xl-3 col-xl-6">
                <label class="form-label" for="token">Ingresa el código de verificación</label>
                <input type="text" class="form-control form-control-lg text-center" id="token" name="token" maxlength="6" placeholder="235789" required>
